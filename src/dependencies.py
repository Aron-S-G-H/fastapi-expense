...
def get_translator(request: Request) -> Callable[[str], str]:
    ...
    try:
        ...
        trans = gettext.translation(
            "messages", localedir=LOCALES_DIR, languages=[DEFAULT_LANG]
        )
        _ = trans.gettext
    return _
...
if settings.AUTH_MODE == "Bearer":
    ...
    def user_dependency_func(
        db: db_dependency, credentials: credential_dependency, locale: locale_dependency
    ) -> UserModel:
